...
module.exports = class HelloCommand extends SlashCommand {
    ...
    async run(ctx) {
        ...
        const values = scl[Object.values(ctx.options)[2] - 1];
        const mmsg = embed.setDescription(stripIndent`
        **Tür:** \`${values.punish} - ${values.type}\`
        **Sebep:**  \`${values.reason}\`
        **Sorumlu:**  ${guild.members.cache.get(values.executor) || "Bilinmiyor"}
        **Zaman:** \`${checkDays(values.created)} gün önce\`
        **Süre:** \`${values.duration}\`
